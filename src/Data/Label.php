...
class Label extends Data
{
     ...
     * @param  string|array<string, mixed>|null  $messageListVisibility  Visibility settings for message lists, if provided.
     * @param  string|array<string, mixed>|null  $labelListVisibility  Visibility settings for label lists, if provided.
     ...
     * @param  string|array<string, mixed>|null  $color  The color associated with the label, if specified.
     */
     ...
     *
     * @param  array<string, mixed>  $data  Associative array containing label data, typically from a Gmail API response.
